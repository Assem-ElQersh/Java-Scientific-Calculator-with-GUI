...
public class Calculator {
    ...
    private void initialize() {
        ...
        frmCalculator.setTitle("Assem's Scientific Calculator");
        frmCalculator.getContentPane().setBackground(new Color(155, 186, 99));
        ...
        textField.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (Character.isDigit(keyChar) || keyChar == '.') {
                    ...
                    if (!s.equals("0") && s.charAt(s.length() - 1) != keyChar) {
                        s += keyChar;
                        textField.setText(s);
                        expression += "," + keyChar;
                    }
        ...
        button1.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button3.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button4.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        buttton5.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button6.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button7.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button8.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button9.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button10.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button11.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button12.setBackground(new Color(0, 220, 220));
        button12.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button13.setBackground(new Color(0, 220, 220));
        button13.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button14.setBackground(new Color(0, 220, 220));
        ...
        button15.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button16.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button17.setBackground(new Color(0, 220, 220));
        button17.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button18.setBackground(new Color(0, 220, 220));
        button18.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button19.setBackground(new Color(0, 220, 220));
        button19.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button20.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button21.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button22.setBackground(new Color(0, 220, 220));
        button22.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button23.setBackground(new Color(0, 220, 220));
        button23.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button24.setBackground(new Color(0, 220, 220));
        button24.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button27.setFont(new Font("SansSerif", Font.PLAIN, 17));
        ...
        button28.setBackground(new Color(0, 220, 220));
        ...
        button29.setFont(new Font("SansSerif", Font.PLAIN, 22));
        ...
        button30.setFont(new Font("SansSerif", Font.PLAIN, 17));
